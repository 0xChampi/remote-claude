...
<body>
    <div class="header">
        <h1>💻 Remote Shell</h1>
        <div class="pwd" id="pwd">${WORKING_DIR}</div>
    </div>

    <div class="chat-container" id="chatContainer">
        <div class="message system">
            <div class="message-bubble">
                Connected to remote shell. Type bash commands to execute.
            </div>
        ...
        async function sendMessage() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    addMessage(data.error || 'Command failed', 'system', true);
                }
            } catch (error) {
                hideTyping();
                addMessage('Connection error: ' + error.message, 'system', true);
            } finally {
...
server.listen(PORT, () => {
    console.log('💻 Remote Shell server running on port ' + PORT);
